...
public class MockDataInitializer implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                // Hər dəfə startup olanda kohne mocklari temizleyib tezesini yazsin (opsional,
                // amma ilk defe ucun yaxsidir)
                ...
                // Daha stabil və mütləq açılan şəkil linkləri (Picsum və stabil Unsplash)
                String[] mockImages = {
                ...
                log.info("20 dənə mock data (ultra-stabil şəkillərlə) bazaya yazıldı.");
        }
}
